...
/*   Updated: 2023/11/29 15:49:30 by lde-sous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ShrubberyCreationForm::ShrubberyCreationForm(std::string target) : AForm("Shrubb", 145, 137), target_(target)
{
...
ShrubberyCreationForm::ShrubberyCreationForm(ShrubberyCreationForm const &base) : AForm("Shrubb", 145, 137), target_(base.target_)
{
...
void	ShrubberyCreationForm::execute(Bureaucrat const &executor) const
{
	...
	else
	{
		...
		if (outFile.is_open())
		{
			outFile << shrub;
			outFile.close();
			std::cout << this->getTarget() << " has now a \033[4m\033[32mshrub\033[0m authorized by " << executor.getName() << std::endl;
		}
		else

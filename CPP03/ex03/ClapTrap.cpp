...
/*   Updated: 2023/11/16 15:12:32 by lde-sous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : _name("UNNAMED"), _damage(0), _energypoints(10), _hitpoints(10)
{
	std::cout << "Default constructor" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _damage(0), \
	_energypoints(10), _hitpoints(10)
{
	std::cout << "ClapTrap " << this->_name << " ONline" << std::endl;
	return ;
}

ClapTrap::ClapTrap(ClapTrap const &base): _name(base.getName())
{
